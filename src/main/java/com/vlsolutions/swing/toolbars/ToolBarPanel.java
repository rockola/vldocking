...
/**
 * The toolbar panel is able to receive multiple toolbars and arrange them in many columns or rows
 * (depending on the horizontal/vertical orientation).
 *
 * <p align="center"><img src="doc-files/overview.gif"><br>
 * The ToolBarPanel is a JPanel with a ToolBarPanelLayout. It support horizontal and vertical
 * orientation, and can contain one or more VLToolbars (with given ToolBarContraints for
 * positionning).
 *
...
public class ToolBarPanel extends JPanel {
   ...
   *
   * @param align the alignment value The value of the alignment argument must be one of <code>
   *     FlowLayout.LEFT</code>, <code>FlowLayout.RIGHT</code>, <code>FlowLayout.CENTER</code>,
  ...
  /**
   * Adds a new JToolBar to the Panel at the given row. Multiple VLToolBars are constructed using
   * Separators in the original JToolBar
   */
  ...
  /**
   * Helper function to convert a JToolBar into multiple VLToolBar objects. The JToolBar is split at
   * the separator boundary to create VLToolbars
   *
