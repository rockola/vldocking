 ...
 *
 * <p>returns useful informations such as the toolbars registered and successfully loaded, and the
 * ones not loaded.
 *
...
public class ToolBarIOReadInfo {
  ...
  /**
   * Return the list of toolbars names (String) found in the stream but not registered (these
   * toolbars cannot be loaded, so the API can only report their name).
   */
