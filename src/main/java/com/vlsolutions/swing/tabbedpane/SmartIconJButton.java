 ...
 *
 * <p>This trick, the SmartIconJButton is an icon faking the behaviour of a button. It uses an
 * Action for reacting to clicks and manages a set of images (default, rollover, pressed, disabled)
 * to behave like a rollover button.
 *
...
public class SmartIconJButton implements Icon, PropertyChangeListener {
   ...
   *
   * <p>The button is enabled and visible.
   */
