 ...
 *
 * <p>This layout is like a BorderLayout but corners are always empty (for example, the TOP
 * component starts with an x coordinate equal to the width of the LEFT component).
 *
