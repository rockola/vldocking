 ...
 *
 * <p>API Users will use these constants to interact with the DockingDesktop.
 *
 * <p>These constants are defined as enumerations of Hide and Split classes, in order to avoid
 * runtime errors.
 *
...
public class DockingConstants {
  ...
  /**
   * A constant describing a VERTICAL splitting operation where the new component goes on the TOP
   * part
   */
  public static final Split SPLIT_TOP = new Split(INT_SPLIT_TOP);

  /**
   * A constant describing an HORIZONTAL splitting operation where the new component goes on the
   * LEFT part
   */
  public static final Split SPLIT_LEFT = new Split(INT_SPLIT_LEFT);

  /**
   * A constant describing a VERTICAL splitting operation where the new component goes on the BOTTOM
   * part
   */
