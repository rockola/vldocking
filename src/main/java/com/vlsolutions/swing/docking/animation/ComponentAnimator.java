 ...
 *
 * <p>This class moves/resizes a Component given a start and end Rectangle and a duration.
 *
 * <p>Movements and listeners notifications are processed in the Swing Event Thread.
 *
...
public class ComponentAnimator {
  ...
  /**
   * Reusable component animator. To start an animation, don't forget to call the {@link #start()
   * start() }method.
   */
  public ComponentAnimator(
      Component comp, Rectangle startBounds, Rectangle endBounds, float duration) {
    this.comp = comp;
    this.startBounds = startBounds;
    this.endBounds = endBounds;
    this.duration = duration;
   ...
   *
   * <p>The component is <code>setBounds</code>ed to startBounds and made visible, than a Swing
   * timer is started to process the animation (refresh rate is 100 ms).
   *
