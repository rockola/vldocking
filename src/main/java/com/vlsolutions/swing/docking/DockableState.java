 ...
 *
 * <p>This class is a simple record of a dockable and its current display state.
 *
 * <p>It is used together with DockableStateChangeEvents (and listeners) to track changes of
 * Dockable visibility.
 *
...
public class DockableState implements Comparable {
  ...
  // private static final String [] stateNames = {"CLOSED", "DOCKED", "HIDDEN", "MAXIMIZED",
  // "FLOATING"};
  ...
  /**
   * Returns the relative restore position of the dockable when it is not shown (auto-hide or
   * closed).
   *
   * <p>Please note that this position is meaningless for visible components (as it is not
   * automatically calculated at every move / resize of the dockable ).
   */
  ...
  /**
   * Utility (compatibility) method used to associate an int to the Location enumeration (opposite
   * to location.ordinal()
   */
