...
/**
 * An utility class providing default implementation of usefull actions for pop-up menus in tab
 * container selectors.
 *
 * <p>
 *
...
public class TabbedContainerActions {
  ...
  private static final String ICONIFY_TEXT =
      UIManager.getString("DockTabbedPane.minimizeButtonText");
  private static final String RESTORE_TEXT =
      UIManager.getString("DockTabbedPane.restoreButtonText");
  private static final String MAXIMIZE_TEXT =
      UIManager.getString("DockTabbedPane.maximizeButtonText");
   ...
   *
   * <p>Action properties : The icon is provided, and also the standard localized "close" message.
   */
  public static Action createCloseAction(final Dockable dockable, final DockingDesktop desktop) {

    AbstractAction action =
        new AbstractAction(CLOSE_TEXT) {
   ...
   *
   * <p>Action properties : The icon is provided, and also an unlocalized "Close all documents"
   * message.
   */
  public static Action createCloseAllAction(final Dockable base, final DockingDesktop desktop) {

    AbstractAction action =
        new AbstractAction("Close all documents") {
  ...
  /**
   * returns an action suitable for closing every dockable contained in a tab excepted the current
   * one.
   *
   * <p>Action properties : The icon is provided, and also an unlocalized "Close all other
   * documents" message.
   */
  public static Action createCloseAllOtherAction(
      final Dockable exception, final DockingDesktop desktop) {

    AbstractAction action =
        new AbstractAction("Close all other documents") {
   ...
   *
   * <p>Action properties : The icon is provided, and also a localized "Maximize" message.
   */
  public static Action createMaximizeTabAction(
      final Dockable dockable, final DockingDesktop desktop) {

    AbstractAction action =
        new AbstractAction(MAXIMIZE_TEXT) {
   ...
   *
   * <p>Action properties : The icon is provided, and also a localized "Iconify" message.
   */
  public static Action createHideTabAction(final Dockable dockable, final DockingDesktop desktop) {

    AbstractAction action =
        new AbstractAction(ICONIFY_TEXT) {
   ...
   *
   * <p>Action properties : The icon is provided, and a default "Detach" message.
   */
  public static Action createFloatTabAction(final Dockable dockable, final DockingDesktop desktop) {

    AbstractAction action =
        new AbstractAction(FLOAT_TEXT) {
   ...
   *
   * <p>Action properties : The icon is provided, and a default "Attach" message.
   *
   * @since 2.0.1
   */
  public static Action createAttachTabAction(
      final Dockable dockable, final DockingDesktop desktop) {

    AbstractAction action =
        new AbstractAction(ATTACH_TEXT) {
