 ...
 *
 * <p>This class allows dockable nesting, with full support for workspace save and restore.
 *
 * <p>Currently this class is associated to a CompoundDockingPanel component : you insert dockables
 * into it with an initial addDockable(CompoundDockable) invocation from DockingDesktop, and further
 * dockables with split/createTab calls.
 *
 * <p>Example :
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>CompoundDockables are displayed as SingleDockableContainers (with a title bar). Don't forget
 * to properly initialize the DockKey of this dockable to have it well presented on screen (name,
 * tooltip, icon).
 *
...
public class CompoundDockable implements Dockable {
   ...
   *
   * <p>Implementation note : this method always returns a CompoundDockingPanel.
   */
