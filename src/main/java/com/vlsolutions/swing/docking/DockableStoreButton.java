 ...
 * workspaces).
 *
 * <p>The button is able to display the Icon, text and toolip of a dockable key, and can be used as
 * a drag source (to initiate a drop into a desktop).
 *
...
public class DockableStoreButton extends JButton implements DockDropReceiver, DockableDragSource {
  ...
  private String emptyTooltip =
      "<html>Move and drop a view of your application above this button to store it";
  private Icon emptyIcon = null;
  private String fullText = "View &1 stored";
  private String fullTooltip =
      "<html>Drag this button to move the view <b>&1</b> to a new position";
  ...
  /**
   * Override this method if you want to change the display (text and icon) of this button and the
   * default settings don't suit your needs.
   */
  ...
  /**
   * Updates the text used as tooltip for this button when no dockable is stored. The special value
   * '&1' will be replaced by the name of this dockable.
   *
   * <p>For example "&1 stored" could be replaced by "MyDockable stored"
   */
