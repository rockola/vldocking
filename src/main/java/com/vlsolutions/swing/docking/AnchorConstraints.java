...
public class AnchorConstraints {
   ...
   *
   * @param anchor value expressed as a bitwise OR between ANCHOR_ fields (for example
   ...
   *
   * <p>Anchor is expressed as a bitwise OR between ANCHOR_ fields (for example
   * ANCHOR_TOP|ANCHOR_LEFT)
   */
