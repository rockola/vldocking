 ...
 *
 * <p>A Dockview is the component responsible for displaying a single user component inside a
 * DockingPanel.
 *
 * <p>The DockView contains a DockViewTitleBar, used as a header to display useful information and
 * optional controls (close/maximize/hide/float)
 *
 * <p>UI : The user component is displayed with decorations provided by a {@link
 * com.vlsolutions.swing.docking.ui.DockViewUI} delegate.
 *
 * <p>Here is an example (VLDocking 1.1 "shadow" style) :
 *
 * <ul>
 ...
 * </ul>
 *
 * <p align="center"><img src="doc-files/dockview.gif" alt="Sample DockView" >
 *
 * <p>Note : multiple user-components are not displayable by the dockview : the default
 * implementation of TabbedDockableContainer is the {@link DockTabbedPane}.
 *
 ...
 * @update 2007/01/08 Lilian Chamontin : delegated the creation of the titlebar to allow easy
 *     override.
 */
public class DockView extends JPanel implements DockDropReceiver, SingleDockableContainer {
   ...
   *
   * <p>A {@link #setDockable(Dockable)} call is requiered for this constructor to be usefull.
   */
  public DockView() {
   ...
   * {@inheritDoc}
   *
   * <p>Please note that a drag into a DockView can also lead to create a DockTabbedPane.
   */
