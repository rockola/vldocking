 ...
 *
 * <p>Two types of border can be drawn : full shadow border and half shadow border.
 *
 * <ul>
 *   <li>full shadow border paints darker lines on top and left to define a rectangular shape (this
 *       is the kind of border used by DockableContainers (DockViews). <liI> half shadow border
 *       paints only a shadow (nothing on top and right) : it is used for DockedTabbedPane contents.
 * </ul>
 *
...
public class ShadowBorder implements Border {
  ...
  private static Image shadowImage =
      new ImageIcon(ShadowBorder.class.getResource("shadow.png")).getImage();
