 ...
 *
 * <p>Uses <code>DockView</code> as a <code>SingleDockableContainer</code>, and <code>DockTabbedPane
 * </code> as a <code>TabbedDockableContainer</code>
 *
 * <p>Note : the API has changed between VLDocking 1.1 and 2.0 : the createDockableContainer now
 * uses a second parameter to specify the context of the container creation.
 *
...
public class DefaultDockableContainerFactory extends DockableContainerFactory {
   ...
   *
   * <p>Current implementation uses the DockTabbedPane class.
   *
   * @see DockTabbedPane
   */
