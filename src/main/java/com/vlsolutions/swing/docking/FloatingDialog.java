 ...
 * @since 2.0
 * @update 2005/10/06 Lilian Chamontin : Reworked the layout (added border components) to have
 *     better cursor and resize management and to allow nesting dockables as tabs.
 */
