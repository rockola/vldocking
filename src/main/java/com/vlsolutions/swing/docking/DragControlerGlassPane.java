...
public class DragControlerGlassPane extends JComponent {
    ...
    if (stopDragCursor == null) {
      ...
      stopDragCursor =
          Toolkit.getDefaultToolkit()
              .createCustomCursor(stopDragImage, new Point(16, 16), "stopdragcursor");
    }
  ...
  public void showSwapDragCursor() {
    if (swapDragCursor == null) {
      ...
      swapDragCursor =
          Toolkit.getDefaultToolkit()
              .createCustomCursor(swapDragImage, new Point(16, 16), "swapdragcursor");
    }
  ...
  public void showFloatCursor() {
    if (floatCursor == null) {
      ...
      floatCursor =
          Toolkit.getDefaultToolkit()
              .createCustomCursor(floatImage, new Point(16, 16), "floatcursor");
    }
  ...
  public void showDragCursor() {
    if (dragCursor == null) {
      ...
      dragCursor =
          Toolkit.getDefaultToolkit()
              .createCustomCursor(dragImage, new Point(16, 16), "dragcursor");
    }
