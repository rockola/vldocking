 ...
 * </UL>
 *
 * <p>It is also possible to track changes before they occurs with the DockableStateWillChangeEvent,
 * which is triggered before the change is processed (this event is vetoable).
 *
...
public class DockableStateChangeEvent {
  ...
  /**
   * returns the previous state of the dockable, or null if the component wasn't known to the
   * docking desktop before.
   */
