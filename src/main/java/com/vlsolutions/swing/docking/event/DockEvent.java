...
public abstract class DockEvent {
  ...
  /**
   * The action corresponding to the drag and drop gesture (actions can be seen as allowed docking
   * gestures)
   */
   ...
   *
   * <p><b> note that mouse coordinates are converted into the target's coordinates.</b>
   *
   ...
   *
   * <p>As of version 2.1, this method returns the "target" desktop (the one in which the drop will
   * occur)
   *
   * <p>To get a reference of the "source" desktop, use the DockableState information provided by
   * the DockingContext.
   */
