 ...
 * </UL>
 *
 * <p>Note that event are not triggered by drag-dock moves (they don't correspond to a state
 * change). If you need to track such changes, use a Swing AncestorListener, or override the
 * addNotify method of your dockable component.
 *
 * <p>It is also possible to track changes after they occur with the DockableStateChangeEvent .
 *
...
public class DockableStateWillChangeEvent {
  ...
  /**
   * Returns the future (proposed) state of the dockable. if cancel() is called on the event, this
   * state change will be vetoed.
   *
   * @see #cancel()
   */
