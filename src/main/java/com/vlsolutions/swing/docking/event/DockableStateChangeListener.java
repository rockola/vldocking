 ...
 *
 * <p>Events are triggered when a Dockable component is :
 *
 * <ul>
 ...
 * @see
 *     com.vlsolutions.swing.docking.DockingDesktop#addDockableStateChangeListener(DockableStateChangeListener)
...
public interface DockableStateChangeListener {
  ...
  /**
   * this method will be called after a dockable component has changed of state (closed, hidden,
   * docked)
   */
