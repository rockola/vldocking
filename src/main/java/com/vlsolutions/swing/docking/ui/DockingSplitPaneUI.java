...
public class DockingSplitPaneUI extends BasicSplitPaneUI {
  ...
  private static BufferedImage horizontalImage =
      (BufferedImage) UIManager.get("SplitContainer.hImage");
  private static BufferedImage verticalImage =
      (BufferedImage) UIManager.get("SplitContainer.vImage");

  private static int dividerSize = UIManager.getInt("SplitContainer.dividerSize");

  private static boolean isSplitResizingEnabled =
      UIManager.getBoolean("SplitContainer.isResizingEnabled");

  public DockingSplitPaneUI() {}

  /**
   * if true, the UI will paint shadowed dots along the split pane divider, if false, the divider
   * will remain empty. Default is false
   *
  ...
  class DockingSplitPaneDivider extends BasicSplitPaneDivider {
    ...
    public void paint(Graphics g) {
      ...
      if (useCustomImages) {
        ...
        BufferedImage image =
            getOrientation() == JSplitPane.HORIZONTAL_SPLIT ? verticalImage : horizontalImage;
