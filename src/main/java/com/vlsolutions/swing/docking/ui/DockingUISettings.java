 ...
 *
 * <p>There are two ways of modifying the look and feel of the docking framework :
 *
 * <ul>
...
public class DockingUISettings {
  ...
  /**
   * Allows replacement of the settings instance (used to override global look and feel settings of
   * the framework.
   *
   * <p>This method must be called before DockingDesktop is referenced, as the settings are
   * statically installed at that moment.
   */
  ...
  /**
   * Installs the UI settings. This is executed only once, and automatically called at
   * DockingDesktop class loading in case it was not called by the application.
   */
   ...
   *
   * <p>The Docking framework uses references of UI elements from this class to install its UI
   * according to the look and feel. When Laf is changed, and before calling
   * SwingUtilities.updateComponentTreeUI(topLevelComponent), invoke updateUI() in order to reset
   * everything.
   *
   * <p>Calling this method after SwingUtilities.updateComponentTreeUI(topLevelComponent) is
  ...
  public void installBorderSettings() {
    ...
    Border flatSingleBorder =
        BorderFactory.createCompoundBorder(
            BorderFactory.createEmptyBorder(1, 1, 1, 1), innerFlatSingleBorder);
  ...
  public void installAutoHideSettings() {
    ...
    UIManager.put(
        "AutoHideButtonPanelUI", "com.vlsolutions.swing.docking.ui.AutoHideButtonPanelUI");
    UIManager.put(
        "AutoHideExpandPanelUI", "com.vlsolutions.swing.docking.ui.AutoHideExpandPanelUI");
  ...
  public void installIcons() {
    ...
    Icon closeRolloverIcon =
        new ImageIcon(getClass().getResource(prefix + "close16v2rollover.png"));
    ...
    Icon closeTabRolloverIcon =
        new ImageIcon(getClass().getResource(prefix + "close16tabRollover.png"));
    Icon closeTabPressedIcon =
        new ImageIcon(getClass().getResource(prefix + "close16tabPressed.png"));
    ...
    Icon maximizeRolloverIcon =
        new ImageIcon(getClass().getResource(prefix + "maximize16v2rollover.png"));
    Icon restoreIcon = new ImageIcon(getClass().getResource(prefix + "restore16v2.png"));
    Icon restoreRolloverIcon =
        new ImageIcon(getClass().getResource(prefix + "restore16v2rollover.png"));
    ...
    Icon floatRolloverIcon =
        new ImageIcon(getClass().getResource(prefix + "float16v2rollover.png"));
    ...
    Icon attachRolloverIcon =
        new ImageIcon(getClass().getResource(prefix + "attach16v2rollover.png"));
    Icon attachPressedIcon =
        new ImageIcon(getClass().getResource(prefix + "attach16v2pressed.png"));
    ...
    UIManager.put(
        "DockViewTitleBar.dock", new ImageIcon(getClass().getResource(prefix + "dock16v2.png")));
    UIManager.put("DockViewTitleBar.dock.rollover", dockRolloverIcon);
    UIManager.put(
        "DockViewTitleBar.dock.pressed",
  ...
  public void installAccelerators() {
    ...
    UIManager.put(
        "DockingDesktop.floatActionAccelerator",
  ...
  public void installToolBarSettings() {
    ...
    UIManager.put(
        "ToolBarPanel.bottomBorder", new ToolBarPanelBorder(ToolBarPanelBorder.BOTTOM_PANEL));
    UIManager.put(
        "ToolBarPanel.rightBorder", new ToolBarPanelBorder(ToolBarPanelBorder.RIGHT_PANEL));
  }
