 ...
 *
 * <p>Default behaviour in to install a shadow border on the dockview, but this can be replaced by
 * overriding the 3 install<i>XXX</i>DockableBorder methods.
 *
...
public class DockViewUI extends PanelUI {
  ...
  /**
   * Ancestor listener used to install different borders depending on the usage of the dock view
   * (docked, maximized, tabbed).
   */
