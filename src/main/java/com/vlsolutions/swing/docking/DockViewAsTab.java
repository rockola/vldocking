 ...
 *
 * <p>Please note this component is still in its early stages and might change in future releases.
 *
 * <p>To use it, just install the TabFactory as DockableContainerFactory
 *
...
public class DockViewAsTab extends DockView implements SingleDockableContainer {
  ...
  protected void configureFloatButton() {
    ...
    if (isFloatButtonDisplayed) {
      ...
      // add a tooltip
      floatAction.putValue(
          AbstractAction.SHORT_DESCRIPTION, UIManager.get("DockViewTitleBar.floatButtonText"));
    }
  }
  ...
  protected void configureHideButton() {
    ...
    if (isHideButtonDisplayed) {
      ...
      // add a tooltip
      hideAction.putValue(
          AbstractAction.SHORT_DESCRIPTION, UIManager.get("DockViewTitleBar.minimizeButtonText"));
    }
  }
  ...
  protected void configureCloseButton() {
    ...
    if (isCloseButtonDisplayed) {
      ...
      closeAction.putValue(
          AbstractAction.SHORT_DESCRIPTION, UIManager.get("DockTabbedPane.closeButtonText"));
    }
  }
