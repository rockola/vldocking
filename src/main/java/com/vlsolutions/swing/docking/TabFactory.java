 ...
 *
 * <p>This factory provides a unified GUI for single AND tabbed components (with the exception of
 * auto-hide and single-floating that still use the standard title bars).
 *
 * <p>It is still in an early stage and will be improved in future releases, depending on its
 * adoption.
 *
