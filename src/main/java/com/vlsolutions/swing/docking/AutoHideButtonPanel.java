...
public class AutoHideButtonPanel extends JPanel {
  ...
  /**
   * Constructs a new AutoHideButtonPanel, with a shared expandPanel, and for a specified border
   * zone.
   *
   ...
   *
   * <p>Values are : AutoHideButtonPanel.TOP, AutoHideButtonPanel.LEFT, AutoHideButtonPanel.BOTTOM,
